#ifndef AUTO_AIM_TARGETING__PLANNING__BALLISTICS_SOLVER_HPP_
#define AUTO_AIM_TARGETING__PLANNING__BALLISTICS_SOLVER_HPP_
...
#endif  // AUTO_AIM_TARGETING__PLANNING__BALLISTICS_SOLVER_HPP_
