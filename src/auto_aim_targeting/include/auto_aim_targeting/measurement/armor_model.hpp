#ifndef AUTO_AIM_TARGETING__MEASUREMENT__ARMOR_MODEL_HPP_
#define AUTO_AIM_TARGETING__MEASUREMENT__ARMOR_MODEL_HPP_
...
inline constexpr const char * ARMOR_TYPE_STR[] = {"small", "large"};
...
#endif  // AUTO_AIM_TARGETING__MEASUREMENT__ARMOR_MODEL_HPP_
