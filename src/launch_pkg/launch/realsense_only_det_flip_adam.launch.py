...
def generate_launch_description():
    ...
    # yolov8 path
    model_file_path  = os.path.join(launch_pkg_dir, 'resources', 'yolov8-adam.onnx') 
    engine_file_path  = os.path.join(launch_pkg_dir, 'resources', 'yolov8-adam.plan')
    ...
    tensor_rt_node = ComposableNode(
        ...
        parameters=[{
            'model_file_path': '/workspaces/isaac_ros-dev/src/launch_pkg/resources/yolov8-adam.onnx',
            'engine_file_path': '/workspaces/isaac_ros-dev/src/launch_pkg/resources/yolov8-adam.plan',
