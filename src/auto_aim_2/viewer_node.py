...
# Optional import: only present once auto_aim_2 package is built.
try:
    from auto_aim_2.msg import ArmorKeypointArray
    HAVE_KEYPOINTS = True
except ImportError:
    ...
    def __init__(self):
        ...
        if HAVE_KEYPOINTS:
            ...
            self.get_logger().warn(
                "auto_aim_2.msg.ArmorKeypointArray not available — keypoint overlay disabled.")
