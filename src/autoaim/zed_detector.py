...
# now a ROS parameter (see config/sensors/zed.yaml) so the camera/runtime can be
...
class Yolo26PoseKeypointsNode(Node):
    def __init__(self):
        ...
        # config/sensors/zed.yaml without editing this file. Defaults reproduce
        ...
        # physical sensor produces the "left image" (see media/docs field manual).
        ...
        # via config/sensors/zed.yaml. EXPOSURE/GAIN are only applied in manual
