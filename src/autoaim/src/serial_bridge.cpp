// =============================================================================
// serial_bridge.cpp — microcontroller serial transport
//
// C++ avoids runtime and scheduler jitter on the latency-sensitive TX path.
// Optional low_latency ioctl and SCHED_FIFO priority are off by default.
//
...
//     CRC8 poly 0x07 init 0x00 (see media/docs/autoaim_update.md).
//
// /micro_status layout (unchanged): RX[0..9] + TX echo [yaw, pitch, shoot,
//   nav_x, nav_y, nav_angle] = 16 floats.
//
// Node name, topic names, parameters, and wire protocol are runtime contracts.
// =============================================================================
...
public:
    ...
    t_start_(std::chrono::steady_clock::now())
  {
    ...
    // Optional tuning. Defaults preserve the established wire behavior:
    //   serial_parity: PARITY_EVEN is kept as default.
