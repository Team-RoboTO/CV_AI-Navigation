...
def autoaim_params():
    return [
        ...
        {"barrel_offset_x": 0.0},
        {"barrel_offset_y": 0.0},     # <- MEASURE (lens-cover trick, see media/docs/autoaim_update.md)
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Standard defaults to the RealSense competition path; camera:=zed selects ZED.
